          ...
          children: [
            ...
            ...defaultValues.keys.map((key) {
              return Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  if (key == 'Age') Text('Age', style: TextStyle(color: Colors.white)),
                  if (key != 'Age') Text(key, style: TextStyle(color: Colors.white)),
                  Slider(
                    min: (key == 'Age') ? 16 : ((key == 'Total mentality' || key == 'Total power') ? 1 : 0),
                    max: (key == 'Age') ? 60 : ((key == 'Total mentality' || key == 'Total power') ? 500 : (key == 'International reputation') ? 5 : 100),
                    divisions: 100,
